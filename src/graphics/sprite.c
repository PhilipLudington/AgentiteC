...
Carbon_SpriteRenderer *carbon_sprite_init(SDL_GPUDevice *gpu, SDL_Window *window)
{
    ...
    SDL_GPUBufferCreateInfo vb_info = {
        ...
        .size = SPRITE_VERTEX_CAPACITY * sizeof(Carbon_SpriteVertex),
        .props = 0
    };
    ...
    SDL_GPUBufferCreateInfo ib_info = {
        ...
        .size = SPRITE_INDEX_CAPACITY * sizeof(uint16_t),
        .props = 0
    };
                                      ...
                                      const void *pixels)
{
    ...
    Carbon_Texture *texture = calloc(1, sizeof(Carbon_Texture));
                         ...
                         SDL_GPURenderPass *pass)
{
    ...
    SDL_GPUTransferBufferCreateInfo transfer_info = {
        .usage = SDL_GPU_TRANSFERBUFFERUSAGE_UPLOAD,
        .size = sr->vertex_count * sizeof(Carbon_SpriteVertex),
        .props = 0
    };
    SDL_GPUTransferBuffer *transfer = SDL_CreateGPUTransferBuffer(sr->gpu, &transfer_info);
    if (!transfer) return;
...
void carbon_sprite_upload(Carbon_SpriteRenderer *sr, SDL_GPUCommandBuffer *cmd)
{
    ...
    if (copy_pass) {
        ...
        SDL_GPUTransferBufferLocation src_idx = {
            .transfer_buffer = transfer,
            .offset = sr->vertex_count * sizeof(Carbon_SpriteVertex)
        };
        SDL_GPUBufferRegion dst_idx = {
            .buffer = sr->index_buffer,
            .offset = 0,
            .size = sr->index_count * sizeof(uint16_t)
        };
