...
#ifndef CARBON_NETWORK_MAX_NODES
#define CARBON_NETWORK_MAX_NODES 4096
#endif

/* Maximum connected networks (groups) */
#ifndef CARBON_NETWORK_MAX_GROUPS
#define CARBON_NETWORK_MAX_GROUPS 256
#endif

/* Invalid node/group ID */
#define CARBON_NETWORK_INVALID UINT32_MAX

/**
 * @brief Opaque network system handle
 */
typedef struct Carbon_NetworkSystem Carbon_NetworkSystem;

/**
 * @brief Node information structure
 */
typedef struct Carbon_NetworkNode {
    uint32_t id;            /**< Node ID */
 ...
 */
typedef struct Carbon_NetworkGroup {
 ...
 */
typedef struct Carbon_NetworkCoverage {
...
} Carbon_NetworkCoverage;

/**
 * @brief Callback for network change events
 */
typedef void (*Carbon_NetworkCallback)(Carbon_NetworkSystem *network,
                                        uint32_t node_id,
                                        uint32_t old_group,
                                        uint32_t new_group,
                                        void *userdata);
 ...
 * @return Node ID or CARBON_NETWORK_INVALID on failure
 *
 ...
 * @param network Network system
 * @param node_id Node ID
 * @return Group ID or CARBON_NETWORK_INVALID if not found
 *
 * @note Call carbon_network_update() first to ensure accurate results
 */
 ...
 * @return Node ID or CARBON_NETWORK_INVALID if none found
 */
 ...
 * @return Group count
 *
 * @note Call carbon_network_update() first
 */
