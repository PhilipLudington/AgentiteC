...
#ifndef CARBON_RATE_H
#define CARBON_RATE_H
...
#ifndef CARBON_RATE_MAX_METRICS
#define CARBON_RATE_MAX_METRICS 32
#endif

/* Maximum number of samples in history */
#ifndef CARBON_RATE_MAX_SAMPLES
#define CARBON_RATE_MAX_SAMPLES 256
#endif

/**
 * @brief Single sample for one metric
 */
typedef struct Carbon_RateSample {
 ...
 */
typedef struct Carbon_RateStats {
 ...
 */
typedef struct Carbon_RateTracker Carbon_RateTracker;
 ...
 *
 * @param metric_count Number of metrics to track (max CARBON_RATE_MAX_METRICS)
 * @param sample_interval Seconds between samples (e.g., 0.5f = twice per second)
 * @param history_size Number of samples to keep (max CARBON_RATE_MAX_SAMPLES)
