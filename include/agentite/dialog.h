...
#ifndef AGENTITE_DIALOG_H
#define AGENTITE_DIALOG_H
...
#ifndef AGENTITE_DIALOG_MAX_TEXT
#define AGENTITE_DIALOG_MAX_TEXT 512
#endif

/** Maximum length of a speaker name */
#ifndef AGENTITE_DIALOG_MAX_SPEAKER_NAME
#define AGENTITE_DIALOG_MAX_SPEAKER_NAME 64
#endif

/** Maximum number of registered events */
#ifndef AGENTITE_DIALOG_MAX_EVENTS
#define AGENTITE_DIALOG_MAX_EVENTS 256
#endif

/** Maximum number of custom speakers */
#ifndef AGENTITE_DIALOG_MAX_SPEAKERS
#define AGENTITE_DIALOG_MAX_SPEAKERS 32
#endif
 ...
 */
typedef enum Agentite_SpeakerType {
    AGENTITE_SPEAKER_SYSTEM = 0,  /**< System/narrator messages */
    AGENTITE_SPEAKER_PLAYER,      /**< Player character */
    AGENTITE_SPEAKER_AI,          /**< AI/computer voice */
    AGENTITE_SPEAKER_NPC,         /**< Generic NPC */
    AGENTITE_SPEAKER_ENEMY,       /**< Enemy/antagonist */
    AGENTITE_SPEAKER_ALLY,        /**< Allied character */
    AGENTITE_SPEAKER_TUTORIAL,    /**< Tutorial hints */
    AGENTITE_SPEAKER_COUNT,

    /** User-defined speaker types start here */
    AGENTITE_SPEAKER_CUSTOM = 100,
} Agentite_SpeakerType;

/**
 * @brief Speaker definition for custom speakers
 */
typedef struct Agentite_Speaker {
    uint32_t id;                                /**< Unique speaker ID */
    Agentite_SpeakerType type;                    /**< Base speaker type */
    char name[AGENTITE_DIALOG_MAX_SPEAKER_NAME];  /**< Display name */
 ...
 */
typedef enum Agentite_DialogPriority {
    AGENTITE_DIALOG_PRIORITY_LOW = 0,     /**< Background chatter */
    AGENTITE_DIALOG_PRIORITY_NORMAL,      /**< Normal messages */
    AGENTITE_DIALOG_PRIORITY_HIGH,        /**< Important messages */
    AGENTITE_DIALOG_PRIORITY_CRITICAL,    /**< Must-see messages */
} Agentite_DialogPriority;
 ...
 */
typedef struct Agentite_DialogMessage {
    char text[AGENTITE_DIALOG_MAX_TEXT];      /**< Message text */
    Agentite_SpeakerType speaker_type;        /**< Speaker type */
    uint32_t speaker_id;                    /**< Custom speaker ID (if CUSTOM) */
    Agentite_DialogPriority priority;         /**< Message priority */
 ...
 */
typedef struct Agentite_DialogEvent {
    int id;                                     /**< Event ID */
    char text[AGENTITE_DIALOG_MAX_TEXT];          /**< Message text */
    Agentite_SpeakerType speaker_type;            /**< Speaker type */
...
} Agentite_DialogEvent;

/* ============================================================================
 * Forward Declarations
 * ========================================================================= */

typedef struct Agentite_DialogSystem Agentite_DialogSystem;
 ...
 */
typedef void (*Agentite_DialogDisplayCallback)(Agentite_DialogSystem *dialog,
                                              const Agentite_DialogMessage *message,
                                              void *userdata);
 ...
 * @param userdata User data pointer
 */
typedef void (*Agentite_DialogDismissCallback)(Agentite_DialogSystem *dialog,
                                              const Agentite_DialogMessage *message,
                                              void *userdata);
 ...
 * @param userdata User data pointer
 */
typedef void (*Agentite_DialogEventCallback)(Agentite_DialogSystem *dialog,
                                            int event_id,
                                            void *userdata);
